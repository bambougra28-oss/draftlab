...
> Généré le 2026-06-10T13:19:56.246Z par le harnais de backtest (walk-forward par patch, IC bootstrap 95 %).
...
- Reproductibilité : seed 42, 1000 resamples bootstrap, ordre des IC fixe (log loss, Brier, accuracy, pick, ban).
